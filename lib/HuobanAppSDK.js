	...
	function client(handlers) {
	  if (!instance.client) {
	    if (_const.isPC || _const.isWap) {
	      ...
	      alert('unknown client type: ' + JSON.stringify({ isClientAndroid: _const.isClientAndroid, isClientIOS: _const.isClientIOS, isWap: _const.isWap, isPC: _const.isPC, isIPhone: _const.isIPhone, isAndroid: _const.isAndroid }));
	    }
	  }
